...
public class Escolhas {
    public void exibirEscolhas(Scanner scanner, Loja loja, Lotes lotes, Inventario inventario, Dinheiro dinheiro, Controle controle) {
        ...
        tratarEscolha(escolha, scanner, loja, lotes, inventario, dinheiro, controle);
    }

    public void tratarEscolha(int escolha, Scanner scanner, Loja loja, Lotes lotes, Inventario inventario, Dinheiro dinheiro, Controle controle) {
        ...
        switch (escolha){
            ...
            case 4:
                ...
                break;
            case 5:
                alimentar.alimentarAnimais(scanner, inventario, lotes);
                break;
            case 6:
